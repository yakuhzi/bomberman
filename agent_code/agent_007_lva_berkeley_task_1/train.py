...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    if len(self.transitions) > 1:
        old_coin_distance = self.transitions[-1][0]["coin_distance"]
        new_coin_distance = old_state_features["coin_distance"]

        # print(old_coin_distance, new_coin_distance)

        if new_coin_distance - old_coin_distance == 1:
            events.append(MOVED_AWAY_FROM_COIN)
        elif old_coin_distance - new_coin_distance == 1:
